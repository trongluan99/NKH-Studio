...
public class NativeConfigManager implements LifecycleEventObserver {
    ...
    public NativeConfigManager(@NonNull Activity activity, @NonNull LifecycleOwner lifecycleOwner, boolean isCondition, boolean isReloadAds, @NonNull String id, int layoutCustomNative, int layoutShimmerAds, @NonNull FrameLayout frAds, @NonNull AdCallback callback, NativeAdConfig nativeAdConfig) {
    ...
    public void loadNativeAds() {
        ...
        if (isCondition) {
            ...
            NkhAd.getInstance().loadNativeAd(activity, id, layoutCustomNative, frAds, shimmerAds, nativeAdConfig, new AdCallback() {
                @Override
